    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Show Time Entries</h5>
                        <div>
                                        ...
                                        <td>
                                            @if($entry->clock_out)
                                                @php
                                                    ...
                                                    $clockOut = \Carbon\Carbon::parse($entry->clock_out)->timezone('Asia/Dhaka');
                                            ...
                                            <!-- Update Button -->
                                            <!-- <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#updateTimeEntryModal{{ $entry->id }}">Update</button> -->
                                            <!-- Delete Form -->
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('time.update', $entry->id) }}" method="POST">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="datetime-local" name="clock_out" id="clock_out{{ $entry->id }}" class="form-control" value="{{ $entry->clock_out ? \Carbon\Carbon::parse($entry->clock_out)->timezone('Asia/Dhaka')->format('Y-m-d\TH:i') : '' }}">
                                                        </div>
